// Toques REALES por campo del teclado propio [AC-FMIG-03] — §5.3, §4.6.
//
// Vive aparte de `toques-flujo.spec.ts` (que mide el FLUJO completo de «publicar día»,
// AC-FRUT-19) porque son dos métricas distintas con dos oráculos distintos, y porque
// fundir las dos suites en un archivo duplicaba cada helper e import (merge del 16-ago).
