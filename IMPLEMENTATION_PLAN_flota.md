...
- [x] (P1) Gate AA axe+Lighthouse de la pantalla de parada: 4.5:1/3:1/7:1, targets, foco, 200% sin truncar, cero aria-labels vacíos — spec: specs/flota/04-pod-offline-sync.md [AC-FPOD-23] — axe installado, 5 tests en pod-accesibilidad-parada.spec.ts contra servidor real (contraste, targets, aria-labels, zoom, foco visible)
