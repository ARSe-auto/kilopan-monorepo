...
- [x] (P1) 100% offline: POD completo sin red con «Entregada — por sincronizar» + contador real; el replay vacía la cola sin intervención — VERDE 11-ago-2026 (e2e/pod-offline.spec.ts, 2 de 2). El «bloqueo por migración» que se le anotó era falso: `db/migraciones-flota/` sí es del motor — spec: specs/flota/04-pod-offline-sync.md [AC-FPOD-03]
