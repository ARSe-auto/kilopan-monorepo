...
- [ ] (P1) Los 4 estados obligatorios de la pantalla de parada (vacío/skeleton/error sin rechazo/sin conexión con contador) — spec: specs/flota/04-pod-offline-sync.md [AC-FPOD-22]
  - AC-ABIERTO: UI de los 4 estados implementada (EstadoVacio, skeleton, EstadoError, sin-conexion); e2e casos (1) y (2) listos, casos (3) y (4) requieren integración completa con fixtures de dispositivo/ruta/parada. Bloqueado por typecheck de AC-FPOD-02/04/10 (propiedades incompletas de CapturaDeEntrega: supersedeDe, secuenciaDispositivo, motivoSupersede, evidencias).
