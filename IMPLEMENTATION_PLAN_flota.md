...
- [ ] (P2) Dos hallazgos de AC-FPOR-13 en código compartido con el operador: `fecha_servicio` sin validar antes del cast `::date` (500 no tipado) y el mismo patrón de `client_uuid` regenerado en cada intento en `bandeja/page.tsx` (doble-tap duplica) — spec: specs/flota/03-encargos-rutas-custodia.md [AC-FRUT-25]
