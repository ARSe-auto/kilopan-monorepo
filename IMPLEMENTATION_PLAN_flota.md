...
- [ ] (P1) PARCIAL: tenant B «Rutapan» sembrado (identidad+vertical+tema+terminología extrema+2 EV48+4 panaderías, `db/flota/seeds/tenant-b.mjs`, test verde). Falta A, C, rutas/manifiestos/DTE/liquidaciones/cierre de A y B, EEVD y el e2e camino dorado con fila-cruzada. Seeds A/B/C EXACTOS según §10 (EV48, empresas y conceptos, terminología extrema de B, C contraído) con centinelas únicos por tenant, RUTs irreales y memoria de cálculo EEVD; fila cruzada ⇒ rojo — spec: specs/flota/08-diseno-miga-onboarding.md [AC-FMIG-18]
