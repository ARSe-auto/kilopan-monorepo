...
- [ ] (P1) API de carga sobre 0024: generar bultos al confirmar, POST escaneo (409 en duplicado), GET estado N/M por ruta — spec: `specs/kilopan/04-despacho-reparto.md` [AC-DES-05]
- [ ] (P1) Pantalla F3 `/cargar`: contador N/M 96 px, captura manual + checklist, banner ámbar en duplicado, salir-a-ruta con la única modal — spec: `specs/kilopan/04-despacho-reparto.md` [AC-DES-06]
