...
- [ ] (P2) UI de resolución de mermas al día siguiente (REABIERTO 08-ago: pantalla y endpoint commiteados en 111dee9; su e2e aún rojo — 3 defectos del test corregidos, falta que la merma aparezca listada): hoy la máquina de estados existe y la TCK la respeta, pero nadie puede mover una merma a `recuperada_con_venta` desde pantalla — spec: `specs/kilopan/02-catalogo-pesaje.md` [AC-MERM-02]
