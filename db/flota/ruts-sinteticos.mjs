...
VALIDOS["14.555.666-3"] = "la gestora de apps/flota/e2e/torre-de-control.spec.ts (AC-FTEL-04), propia y no prestada: la suite comparte el tenant `hechos` con `rastreo.spec.ts`/`rastreo-outbox.spec.ts` (AC-FTEL-01/03) y necesita su propio RUT para no chocar con duplicate key en `personas_tenant_id_rut_key`. Dígito verificador DERIVADO por módulo 11.";
